  ...
  : BaseGame(dc, bounds)
{
  ...
  const Length stableCircleR = (std::min)(bounds.GetWidth(), bounds.GetHeight()) / 5;
  ...
  const Length circleR = (std::min)(bounds.GetWidth(), bounds.GetHeight()) / 10;
